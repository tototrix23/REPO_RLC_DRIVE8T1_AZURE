...
#define RM_BLOCK_MEDIA_SPI_CUSTOM_OPEN    (0x51535049U)
...
const rm_block_media_api_t g_rm_block_media_on_spi_custom =
{
    .open        = RM_BLOCK_MEDIA_SPI_CUSTOM_Open,
    .mediaInit   = RM_BLOCK_MEDIA_SPI_CUSTOM_MediaInit,
    .read        = RM_BLOCK_MEDIA_SPI_CUSTOM_Read,
    .write       = RM_BLOCK_MEDIA_SPI_CUSTOM_Write,
    .erase       = RM_BLOCK_MEDIA_SPI_CUSTOM_Erase,
    .callbackSet = RM_BLOCK_MEDIA_SPI_CUSTOM_CallbackSet,
    .statusGet   = RM_BLOCK_MEDIA_SPI_CUSTOM_StatusGet,
    .infoGet     = RM_BLOCK_MEDIA_SPI_CUSTOM_InfoGet,
    .close       = RM_BLOCK_MEDIA_SPI_CUSTOM_Close,
};
...
static fsp_err_t rm_block_media_spi_custom_erase(rm_block_media_spi_instance_ctrl_t * p_instance_ctrl,
                                            uint32_t const                       block);

static fsp_err_t rm_block_media_spi_custom_program(rm_block_media_spi_instance_ctrl_t * p_instance_ctrl,
                                            uint8_t                            * p_device_address,
                                            uint8_t const                      * p_buffer,
                                            uint32_t const                       num_blocks);

static fsp_err_t rm_block_media_spi_custom_rom_read(rm_block_media_spi_instance_ctrl_t * p_instance_ctrl,
                                             uint8_t * const                      p_dest,
                                             uint32_t const                       start_block,
                                             uint32_t const                       num_blocks);

static void rm_block_media_call_callback_custom(rm_block_media_spi_instance_ctrl_t * p_instance_ctrl,
...
fsp_err_t RM_BLOCK_MEDIA_SPI_CUSTOM_Open (rm_block_media_ctrl_t * const p_ctrl, rm_block_media_cfg_t const * const p_cfg)
{
...
#if RM_BLOCK_MEDIA_SPI_CUSTOM_CFG_PARAM_CHECKING_ENABLE
    FSP_ASSERT(NULL != p_cfg);
    FSP_ASSERT(NULL != p_cfg->p_extend);
    FSP_ASSERT(NULL != ((rm_block_media_spi_extended_cfg_t *) p_cfg->p_extend)->p_spi);
    FSP_ASSERT(NULL != p_instance_ctrl);
    FSP_ERROR_RETURN(RM_BLOCK_MEDIA_SPI_CUSTOM_OPEN != p_instance_ctrl->open, FSP_ERR_ALREADY_OPEN);
#endif
    ...
    /* Module is now open */
    p_instance_ctrl->open = RM_BLOCK_MEDIA_SPI_CUSTOM_OPEN;
...
fsp_err_t RM_BLOCK_MEDIA_SPI_CUSTOM_InfoGet (rm_block_media_ctrl_t * const p_ctrl, rm_block_media_info_t * const p_info)
{
    ...
    FSP_ERROR_RETURN(RM_BLOCK_MEDIA_SPI_CUSTOM_OPEN == p_instance_ctrl->open, FSP_ERR_NOT_OPEN);
                                   ...
                                   uint32_t const                num_blocks)
{
    ...
    fsp_err_t err = rm_block_media_spi_custom_rom_read(p_instance_ctrl, p_dest, start_block, num_blocks);
    FSP_ERROR_RETURN(FSP_SUCCESS == err, err);
                                    ...
                                    uint32_t const                num_blocks)
{
    ...
    err = RM_BLOCK_MEDIA_SPI_CUSTOM_Erase(p_instance_ctrl, start_block, num_blocks);
    FSP_ERROR_RETURN(FSP_SUCCESS == err, err);
    ...
    err = rm_block_media_spi_custom_program(p_instance_ctrl, (uint8_t *) rom_address, p_src, num_blocks);
    FSP_ERROR_RETURN(FSP_SUCCESS == err, err);
                                    ...
                                    uint32_t const                num_blocks)
{
    ...
    {
        err = rm_block_media_spi_custom_erase(p_instance_ctrl,b);
        b++;
        ...
        {
            rm_block_media_call_callback_custom(p_instance_ctrl, RM_BLOCK_MEDIA_EVENT_POLL_STATUS);
            err = p_spi_flash->p_api->statusGet(p_spi_flash->p_ctrl, &status);
        }*/
    ...
    rm_block_media_call_callback_custom(p_instance_ctrl, event);
                                            ...
                                            uint32_t const                       block)
{
    ...
    volatile uint32_t addr = (uint32_t)(block * p_extended_cfg->block_size_bytes);*/
...
/*******************************************************************************************************************//**
 * This is the subroutine for the RM_BLOCK_MEDIA_SPI_CUSTOM_Write API.
 *
                                             ...
                                             uint32_t const                       num_blocks)
{
    ...
    fsp_err_t              err         = FSP_SUCCESS;
    spi_flash_instance_t * p_spi_flash = p_instance_ctrl->p_spi_flash;
    volatile uint32_t               page_size   = p_spi_flash->p_cfg->page_size_bytes;
    ...
    while ((iteration > 0U) && (FSP_SUCCESS == err))
    {
        ...
        err = flash_write(p_device_address,p_buffer,page_size);
        FSP_ERROR_RETURN(FSP_SUCCESS == err, err);
...
/*******************************************************************************************************************//**
 * This is the subroutine for the RM_BLOCK_MEDIA_SPI_CUSTOM_READ API to read data from banks using ROM area.
 *
 * @retval  FSP_SUCCESS             No parameter error found
 **********************************************************************************************************************/
static fsp_err_t rm_block_media_spi_custom_rom_read (rm_block_media_spi_instance_ctrl_t * p_instance_ctrl,
                                              ...
                                              uint32_t const                       num_blocks)
{
    ...
    volatile int ret = flash_read(rom_address, p_dest, read_bytes);


    /* Notify application of completion */
    p_instance_ctrl->read_in_progress = false;
    rm_block_media_call_callback_custom(p_instance_ctrl, RM_BLOCK_MEDIA_EVENT_OPERATION_COMPLETE);
